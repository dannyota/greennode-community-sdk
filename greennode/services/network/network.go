...
func NewNetworkServiceV2(psvcClient client.IServiceClient) INetworkServiceV2 {
	return &networkv2.NetworkServiceV2{
		VserverClient: psvcClient,
	}
}

func NewNetworkServiceV1(psvcClient client.IServiceClient) INetworkServiceV1 {
	return &networkv1.NetworkServiceV1{
		VNetworkClient: psvcClient,
	}
}

func NewNetworkServiceInternalV1(psvcClient client.IServiceClient) INetworkServiceInternalV1 {
