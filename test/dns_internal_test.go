...
func TestDnsServiceInternal_ListHostedZonesDefault(t *testing.T) {
	...
	if sdkErr != nil {
		t.Fatalf("Failed to list hosted zones: %v", sdkErr.Err())
	}
...
func TestDnsServiceInternal_ListRecordsDefault(t *testing.T) {
	...
	if sdkErr != nil {
		t.Fatalf("Failed to list record: %v", sdkErr.Err())
	}
...
func TestDnsServiceInternal_DeleteRecord(t *testing.T) {
	...
	if sdkErr != nil {
		t.Fatalf("Failed to delete record: %v", sdkErr.Err())
	}
...
func TestDnsServiceInternal_DeleteHostedZone(t *testing.T) {
	...
	if sdkErr != nil {
		t.Fatalf("Failed to delete hosted zone: %v", sdkErr.Err())
	}
...
func TestDnsServiceInternal_ListAndDeleteAllRecords(t *testing.T) {
	...
	if sdkErr != nil {
		t.Fatalf("Failed to list records: %v", sdkErr.Err())
	}
	...
	for _, record := range listResp.ListData {
		...
		if sdkErr != nil {
			t.Logf("Failed to delete record %s: %v", record.RecordID, sdkErr.Err())
			continue
		}
