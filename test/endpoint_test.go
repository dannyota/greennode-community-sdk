...
func TestListEndpointTags(t *testing.T) {
	...
	lb, sdkerr := vngcloud.NetworkInternal.ListTagsByEndpointID(context.Background(), opt)
	if sdkerr != nil {
		t.Fatalf("Expect nil but got %+v", sdkerr)
	}
...
func TestDeleteTagByEndpointID(t *testing.T) {
	...
	sdkerr := vngcloud.NetworkInternal.DeleteTagOfEndpoint(context.Background(), opt)
	if sdkerr != nil {
		t.Fatalf("Expect nil but got %+v", sdkerr)
	}
...
func TestUpdateEndpointTag(t *testing.T) {
	...
	sdkerr := vngcloud.NetworkInternal.UpdateTagValueOfEndpoint(context.Background(), opt)
	if sdkerr != nil {
		t.Fatalf("Expect nil but got %+v", sdkerr)
	}
